...
import SiteAuthenticate from '../(components)/SiteAuthenticate';
        ...
        <div className="flex h-screen items-center justify-center">
          <div className="w-full max-w-md bg-white py-10 px-5">
            ...
            <p className="text-xs text-gray-400 font-normal mt-2 leading-5">
              By registering, you consent to the use of your data for
              registration purposes and to receive product and service
              notifications. You can opt-out of notifications anytime in your
              settings. Refer to our{' '}
              <a href="#" className="text-xs text-blue-700 font-medium">
                Privacy Policy{' '}
              </a>{' '}
              for more details.
