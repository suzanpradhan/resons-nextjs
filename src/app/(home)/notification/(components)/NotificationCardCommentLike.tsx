...
interface NotificationLikeProps {
  id: string;
  comment: CommentDetailType | undefined;
  user: ProfileDetailType | undefined;
  createdAt: string;
  readAt: string | null;
}

const NotificationCardCommentLike = (props: NotificationLikeProps) => {
        ...
        <div className="flex flex-col ml-3 justify-around basis-[250px] sm:basis-auto">
          ...
          >
            ...
            <div className="flex items-center">
              <Heart size="16" color="gray" variant="Bold" />{' '}
...
export default NotificationCardCommentLike;
